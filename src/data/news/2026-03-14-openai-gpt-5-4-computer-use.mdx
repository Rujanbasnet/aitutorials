...
author: "AI Tutorials"
quickAnswer: "GPT-5.4, released March 5, 2026, is OpenAI's first model with native computer-use mode -- it can click, type, and navigate apps on your behalf. It also features a 1-million-token context window (roughly 750,000 words) and is available in ChatGPT, the API, and Codex."
faqs:
  - question: "Can GPT-5.4 control my computer?"
    answer: "Yes. GPT-5.4 has native computer-use mode that lets it click, type, scroll, and navigate desktop applications on your behalf. It's not a bolted-on add-on but a core feature of the model, available through ChatGPT and the API."
  - question: "What is GPT-5.4's context window?"
    answer: "GPT-5.4 supports a 1-million-token context window, roughly equivalent to 750,000 words or six full-length novels. This allows it to process entire codebases, long documents, or extended conversations in a single session."
  - question: "When was GPT-5.4 released?"
    answer: "GPT-5.4 was released on March 5, 2026. It's available in ChatGPT, the OpenAI API, and the Codex coding tool."
