...
**JSON** — The format APIs use to send data back and forth. It looks like this: `{"name": "Rujan", "city": "Hobart"}`. You'll see it in config files, API responses, and error logs constantly.
